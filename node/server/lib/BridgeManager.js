...
var BridgeManager = {
    init:function(){
        ...
        Observer.subscribe(this, Const.notificationUserLeft, function(who, obj) {
            if(_.isEmpty(Settings.listeners))
                return;

            if(_.isFunction(Settings.listeners.onUserLeft))
                Settings.listeners.onUserLeft(obj);
        });
        ...
        Observer.subscribe(this, Const.notificationMessageDeleted, function(who, obj) {
            if(_.isEmpty(Settings.listeners))
                return;

            if(_.isFunction(Settings.listeners.OnMessageDeleted))
                Settings.listeners.OnMessageDeleted(obj);
        });
