...
CellGenerator.prototype.generate = function(messageModel){
    ...
    //console.log('CellGenerator.js:36 - data', messageModel);
    ...
    if(flatData.user_id == LoginUserManager.user.get('id') && Settings.options.useBothSide){
    ...
    console.log('CellGenerator.js:62', flatData);
    var html = '';

    if(messageModel.get('deleted_at') != 0) {
