...
class MY_Model extends Base_Model {
    ...
    //////////////////////////////********************************************my code**************************************//////////////////////////////
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    public function get_where($field, $value=0) {
        if(is_array($field)) {
            return $this->set_where($field)->get_all();
        } else {
            return $this->set_where(array($field => $value))->get_all();
        }
    }

    public function get_first_one_where($field, $value=0){
        $data = $this->get_where($field, $value);
        foreach($data as $d){
            return $d;
        }
    ...
    public function paginate_with_offset($offset = 0, $where = array(), $limit = 10)
    {
        // get filtered results
        $where = array_merge($where, $this->where);
        $this->db->limit($limit, $offset);
    ...
    public function paginate_search($offset = 0, $limit = 10, $where = array(), $other_where = "", $order_by = array())
    {
        if($limit==0) $limit = 10;
        // get filtered results
        $where = array_merge($where, $this->where);
