...
class Notification extends Admin_Controller {
	...
	public function __construct()
	{
        ...
        $this->load->model('User_fcm_token_model', 'userFcmTokens');
	...
	public function index()
	{
        ...
        $crud->columns('sender_id', 'receiver_id', 'type', 'title', 'content', 'created_at');
    ...
    public function create_notification()
    {
        ...
        if ($form->validate()) {
            ...
            $response = $this->sendPushMessage("Your Motor Parts News", $message);
