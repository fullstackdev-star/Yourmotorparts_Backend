...
class Googlemaps {
    ...
    var $apiKey						= 'AIzaSyC9Yp4yhUok9CR3ReeBnXzwCnm7oOELGV4'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
