...
class grocery_CRUD_Layout extends grocery_CRUD_Model_Driver
{
    ...
    protected function get_add_input_fields($field_values = null)
    {
        ...
        foreach ($fields as $field_num => $field) {
            ...
            if ($field_info->crud_type == 'invisible') {
                unset($this->add_fields[$field_num]);
                unset($fields[$field_num]);
                continue;
            } else if ($field_info->crud_type == 'hidden') {
                $this->add_hidden_fields[] = $field_input;
                unset($this->add_fields[$field_num]);
                unset($fields[$field_num]);
                continue;
...
class Grocery_CRUD extends grocery_CRUD_States
{
    ...
    public function set_text_editor($editor)
    {
        $this->config->grocery_crud_default_text_editor = $editor;
    }
    ...
    protected function _initialize_variables($text_editor = '')
    {
        $ci = &get_instance();
        ...
        if ($text_editor) {
            $this->config->default_text_editor = $text_editor;
        }
     ...
     */
    protected function pre_render($text_editor = '')
    {
        $this->_initialize_variables($text_editor);
     ...
     * @access    public
     */
    public function render($text_editor = '')
    {
        $this->pre_render($text_editor);
